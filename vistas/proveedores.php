...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-0">
                <div class="row g-4">
                    ...
                    <div class="modal fade" id="modalAgregarProducto" tabindex="-1"
                        aria-labelledby="modalAgregarProducto" aria-hidden="true">
                            ...
                            <div class="modal-content" style="text-align: center;">
                                            ...
                                            <form id="formAgregarProveedor">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input name="cuit" type="number" class="form-control" id="cuit"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-secondary"
                                        id="guardarProveedorBtn">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Modal de edición -->
            <div class="modal fade" id="modalEditarStock" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="editDomicilio" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="editRazonSocial" class="form-control"
            ...
            <div class="modal fade" id="modalEliminarStock" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
        ...
        <!-- Back to Top -->
        <a href="#" class="btn btn-lg btn-lg-square back-to-top" style="background: #e77a34; color: white"><i
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            guardarProveedorBtn.addEventListener("click", function (evento) {
                ...
                if (cuit === "" || nombre === "" || domicilio === "" || telefono === "" || email === "" || ciudad === "" || razonSocial === "") {
